...
public:
    ...
    void setLayerSrc(CollisionLayer layer) { layerSrc = layer; }

    void setLayerDst(CollisionLayer layer) { layerDst = layer; }

    void setOnCollide(Collide onCollide) { this->onCollide = onCollide; }
